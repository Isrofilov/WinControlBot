...
* **`/sleep`** — Перевести систему в режим сна
...
* **`/status`** — Получить статус системы (имя компьютера, модель CPU, использование RAM, время работы)
* **`/screenshot`** — Сделать и получить скриншот рабочего стола
...
| `/status`     | Имя компьютера, модель CPU, использование RAM, время работы | ✅ Безопасно            |
| `/sleep`      | Перевести компьютер в режим сна                             | ⚠️ Управление питанием  |
| `/hibernate`  | Перевести компьютер в режим гибернации                      | ⚠️ Управление питанием  |
| `/shutdown`   | Выключить систему                                           | ⚠️ Критическая операция |
| `/restart`    | Перезагрузить систему                                       | ⚠️ Критическая операция |
| `/screenshot` | Сделать и отправить скриншот рабочего стола                 | ⚠️ Конфиденциальность   |
...
* **Учитывайте риски скриншотов** — Команда `/screenshot` может передать конфиденциальную информацию
